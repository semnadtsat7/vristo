                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'component' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('component')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Announcement</span>
                                    </div>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'component' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <NavLink to="/components/system-announcement">System Announcement</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/components/school-announcement">School Announcement</NavLink>
                                        </li>
